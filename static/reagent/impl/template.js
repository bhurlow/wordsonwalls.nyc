...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8911__auto__,writer__8912__auto__,opt__8913__auto__){
return cljs.core._write(writer__8912__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__8681__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__8681__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__8681__auto__)){
return or__8681__auto__;
} else {
...
var G__5507 = o;
(G__5507[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__5509__i < G__5509__a.length) {G__5509__a[G__5509__i] = arguments[G__5509__i + 0]; ++G__5509__i;}
  args = new cljs.core.IndexedSeq(G__5509__a,0);
} 
...
var old_5511 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_5511))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_5511)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__8673__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__5514 = jsprops;
(G__5514["defaultValue"] = value);

(G__5514["onChange"] = ((function (G__5514,v,value,on_change){
return (function (p1__5512_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5512_SHARP_);
});})(G__5514,v,value,on_change))
);
...
var vec__5518 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5518,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5518,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5518,(2),null);
...
var temp__4659__auto__ = (function (){var G__5522 = cljs.core.meta(v);
if((G__5522 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__5522);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__5524_5525 = v;
var G__5524_5526__$1 = (((G__5524_5525 == null))?null:reagent.impl.template.key_from_vec(G__5524_5525));
if((G__5524_5526__$1 == null)){
} else {
(jsprops["key"] = G__5524_5526__$1);
}
...
var G__5530 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5530) : reagent.impl.template.as_element.call(null,G__5530));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__5531 = cljs.core.meta(argv);
if((G__5531 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__5531);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__5532 = (((jsprops == null))?({}):jsprops);
(G__5532["key"] = key);
...
var n__9123__auto___5533 = a.length;
var i_5534 = (0);
while(true){
if((i_5534 < n__9123__auto___5533)){
(a[i_5534] = reagent.impl.template.as_element((a[i_5534])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__9123__auto___5536 = a.length;
var i_5537 = (0);
while(true){
if((i_5537 < n__9123__auto___5536)){
var val_5538 = (a[i_5537]);
if((cljs.core.vector_QMARK_(val_5538)) && ((reagent.impl.template.key_from_vec(val_5538) == null))){
(o["no-key"] = true);
} else {
}

(a[i_5537] = reagent.impl.template.as_element(val_5538));
...
var G__5541 = (cljs.core.count(argv) - first_child);
switch (G__5541) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__5541){
