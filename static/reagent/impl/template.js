...
var G__464 = o;
(G__464[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var old_468 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_468))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_468)].join(''):class$));
} else {
}
...
var G__471 = jsprops;
(G__471["defaultValue"] = value);

(G__471["onChange"] = ((function (G__471,v,value,on_change){
return (function (p1__469_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__469_SHARP_);
});})(G__471,v,value,on_change))
);
...
var vec__475 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__475,(0),null);
var id = cljs.core.nth.call(null,vec__475,(1),null);
var class$ = cljs.core.nth.call(null,vec__475,(2),null);
...
var temp__4659__auto__ = (function (){var G__479 = cljs.core.meta.call(null,v);
if((G__479 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__479);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = ({"argv": v});
var G__481_482 = v;
var G__481_483__$1 = (((G__481_482 == null))?null:reagent.impl.template.key_from_vec.call(null,G__481_482));
if((G__481_483__$1 == null)){
} else {
(jsprops["key"] = G__481_483__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__486 = cljs.core.meta.call(null,argv);
if((G__486 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__486);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__487 = (((jsprops == null))?({}):jsprops);
(G__487["key"] = key);
...
var n__9123__auto___488 = a.length;
var i_489 = (0);
while(true){
if((i_489 < n__9123__auto___488)){
(a[i_489] = reagent.impl.template.as_element.call(null,(a[i_489])));
...
var a = cljs.core.into_array.call(null,s);
var n__9123__auto___491 = a.length;
var i_492 = (0);
while(true){
if((i_492 < n__9123__auto___491)){
var val_493 = (a[i_492]);
if((cljs.core.vector_QMARK_.call(null,val_493)) && ((reagent.impl.template.key_from_vec.call(null,val_493) == null))){
(o["no-key"] = true);
} else {
}

(a[i_492] = reagent.impl.template.as_element.call(null,val_493));
...
var G__496 = (cljs.core.count.call(null,argv) - first_child);
switch (G__496) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__496){
