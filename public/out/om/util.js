...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,om$util$force_children),G__18186);
} else {
return G__18186;
}
});
...
var expr__$1 = (function (){var G__18190 = expr;
if(cljs.core.seq_QMARK_.call(null,expr)){
return cljs.core.first.call(null,G__18190);
} else {
return G__18190;
}
})();
