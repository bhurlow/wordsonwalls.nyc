...
var c_465 = (a[i]);
if(cljs.core.truth_((c_465["cljsIsDirty"]))){
(c_465["forceUpdate"])();
} else {
}
...
return cljs.core._write.call(null,writer__8912__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__475 = c;
var G__475__$1 = (((G__475 == null))?null:(G__475["props"]));
if((G__475__$1 == null)){
return null;
} else {
return (G__475__$1["argv"]);
}
});
...
var G__481_482 = (c["cljsRatom"]);
if((G__481_482 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__481_482);
}
