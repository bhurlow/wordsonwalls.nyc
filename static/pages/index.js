...
pages.index.FORTUNE_TIMEOUT = (20000);
...
cljs.core.swap_BANG_.call(null,pages.index.state,cljs.core.assoc,new cljs.core.Keyword(null,"selected-fortue","selected-fortue",-169066785),cljs.core.rand_nth.call(null,new cljs.core.Keyword(null,"names","names",-1943074658).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,pages.index.state))));

return pages.index.save_fortune_state.call(null,new cljs.core.Keyword(null,"selected-fortue","selected-fortue",-169066785).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,pages.index.state)));
});
...
})())?cljs.core.doall.call(null,(function (){var iter__9040__auto__ = (function pages$index$image_animation_$_iter__2249(s__2250){
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__2252),pages$index$image_animation_$_iter__2249.call(null,cljs.core.chunk_rest.call(null,s__2250__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__2252),null);
}
} else {
var x = cljs.core.first.call(null,s__2250__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"image","image",-58725096),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),pages.index.make_url.call(null,cljs.core.nth.call(null,new cljs.core.Keyword(null,"names","names",-1943074658).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,pages.index.state)),x)),new cljs.core.Keyword(null,"style","style",-496642736),((cljs.core.not_EQ_.call(null,x,new cljs.core.Keyword(null,"visible-img","visible-img",697721342).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,pages.index.state))))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"none"], null):null),new cljs.core.Keyword(null,"key","key",-1516042587),x], null)], null),pages$index$image_animation_$_iter__2249.call(null,cljs.core.rest.call(null,s__2250__$2)));
}
} else {
return null;
}
...
var forture = localStorage.getItem("fortune");
var fortune_time = localStorage.getItem("fortune_time");
var now = Date.now();
var expired_QMARK_ = (now > fortune_time);
if(expired_QMARK_){
return cljs.core.println.call(null,"EXPIREDJ");
} else {
return null;
}
});
pages.index.render = (function pages$index$render(){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.w-60.center.green.mt6.pb4","div.w-60.center.green.mt6.pb4",-535255231),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
